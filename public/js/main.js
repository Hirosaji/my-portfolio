...
const language = {
    ja: {
        ...
        work: "Works",
        info: "Profile",
        infoText: "新米の社会人イラストレーターです。<br>女の子を主体としたイラストが得意です。絵柄は、リアルもデフォルメも描きます。背景には、実在する静物や舞台をセルルックに描くことが多いです。また、本業がWebエンジニアなので、Webに最適な形式やデザインのイラスト素材を提案することもできます。",
        infoFormTouch: "お問い合わせ・ご依頼フォーム",
        infoFormText: "イラスト制作などのお問い合わせ・ご依頼は、次の専用フォームにて承っております。",
        infoContactTouch: "連絡先",
        infoContactText: "専用フォーム以外でも、お仕事のご連絡は受け付けています。お気軽にどうぞ！"
    },
    en: {
        name: "Hirosaji",
        illustrator: "illustrator",
