...
function scrollToTop() {
    ...
    const language = {
        ja: {
            ...
            work: "Works",
            info: "Profile",
            infoText: "新米の社会人イラストレーターです。<br>主に女の子を主体としたイラストを描いています。キャラクターの絵柄は、リアルもデフォルメも対応可能です。背景は、実在する静物や舞台を描くことが多く、作風は素朴もフォトリアルも描きます。また、本業がWebエンジニアですので、Webに最適な形式やデザインでイラスト素材を用意することも可能です。",
